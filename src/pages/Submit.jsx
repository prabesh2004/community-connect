      ...
      <Card className="bg-white/5 border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.7)]">
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <textarea id="org-about" className="w-full min-h-[120px] rounded-md bg-black/40 border border-white/20 px-3 py-2 text-sm text-white placeholder:text-white/40" placeholder="Tell us about your mission and volunteer needs."/>
          </div>
