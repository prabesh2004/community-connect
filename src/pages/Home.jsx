...
export default function Home() {
    const borderColors = [
      'border-[rgba(20,184,166,0.5)] shadow-[0_0_15px_rgba(20,184,166,0.2)]', // Teal
      'border-[rgba(245,158,11,0.5)] shadow-[0_0_15px_rgba(245,158,11,0.2)]', // Amber
      'border-[rgba(14,165,233,0.5)] shadow-[0_0_15px_rgba(14,165,233,0.2)]', // Sky Blue
      'border-[rgba(244,63,94,0.5)] shadow-[0_0_15px_rgba(244,63,94,0.2)]'   // Coral
    ];

    return (<div className="flex flex-col min-h-[calc(100vh-4rem)] bg-black relative">
      ...
      <section className="relative z-10 overflow-hidden flex-1 flex flex-col justify-center items-center text-center px-4 py-24 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.08),transparent_55%)]">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="inline-flex items-center gap-2 border border-white/20 rounded-full px-4 py-2 text-xs uppercase tracking-[0.3em] text-white/70 mb-6 animate-pulse-glow">
          Local Impact • Real People
        </motion.div>
        <motion.h1 initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} className="text-5xl md:text-6xl font-extrabold tracking-tight mb-6 max-w-4xl text-white">
          Connect with the Causes You Care About
        </motion.h1>
        <motion.p initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.2 }} className="text-xl md:text-2xl text-white/70 mb-10 max-w-2xl">
        ...
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3 }} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-white/70">
          <div className="border border-[rgba(20,184,166,0.5)] rounded-lg px-4 py-3 bg-white/5 shadow-[0_0_15px_rgba(20,184,166,0.2)]">6 active nonprofits</div>
          <div className="border border-[rgba(245,158,11,0.5)] rounded-lg px-4 py-3 bg-white/5 shadow-[0_0_15px_rgba(245,158,11,0.2)]">18 volunteer roles</div>
          <div className="border border-[rgba(14,165,233,0.5)] rounded-lg px-4 py-3 bg-white/5 shadow-[0_0_15px_rgba(14,165,233,0.2)]">100% community-driven</div>
        </div>
      </section>

      {/* Info Section */}
      <motion.section initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="py-20 px-4 relative z-10">
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.05 }} className="text-left border border-[rgba(20,184,166,0.5)] rounded-2xl p-6 bg-white/5 shadow-[0_0_15px_rgba(20,184,166,0.2)]">
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.12 }} className="text-left border border-[rgba(245,158,11,0.5)] rounded-2xl p-6 bg-white/5 shadow-[0_0_15px_rgba(245,158,11,0.2)]">
              <div className="bg-white text-black w-12 h-12 rounded-full flex items-center justify-center mb-6">
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.18 }} className="text-left border border-[rgba(14,165,233,0.5)] rounded-2xl p-6 bg-white/5 shadow-[0_0_15px_rgba(14,165,233,0.2)]">
              <div className="bg-white text-black w-12 h-12 rounded-full flex items-center justify-center mb-6">
      ...
      <motion.section initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="py-20 px-4 relative z-10">
        ...
        ].map((item, index) => (<motion.div key={item.step} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: Number(item.step) * 0.05 }} className={`border rounded-2xl p-6 bg-white/5 ${borderColors[index % borderColors.length]}`}>
      ...
      <motion.section initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="py-20 px-4 relative z-10">
        ...
        ].map((item, index) => (<motion.div key={item.name} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.08 }} className={`border rounded-2xl p-6 bg-white/5 ${borderColors[(index + 1) % borderColors.length]}`}>
      ...
      <motion.section initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="py-20 px-4 relative z-10">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.05 }} className="border border-[rgba(14,165,233,0.5)] rounded-2xl p-6 bg-white/5 shadow-[0_0_15px_rgba(14,165,233,0.2)]">
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.12 }} className="border border-[rgba(244,63,94,0.5)] rounded-2xl p-6 bg-white/5 shadow-[0_0_15px_rgba(244,63,94,0.2)]">
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.18 }} className="border border-[rgba(20,184,166,0.5)] rounded-2xl p-6 bg-white/5 shadow-[0_0_15px_rgba(20,184,166,0.2)]">
      ...
      <motion.section initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="py-20 px-4 relative z-10">
        ...
        ].map((event, index) => (<motion.div key={event.title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.08 }} className={`border rounded-2xl p-6 bg-white/5 ${borderColors[(index + 2) % borderColors.length]}`}>
      ...
      <motion.section initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="py-20 px-4 relative z-10">
        ...
        ].map((alert, index) => (<motion.div key={alert.title} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.08 }} className={`border rounded-2xl p-6 bg-white/5 ${borderColors[(index + 3) % borderColors.length]}`}>
                <div className="flex items-center justify-between">
      ...
      <motion.section initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="py-20 px-4 relative z-10">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="border border-white/10 rounded-2xl p-6 bg-white/5 shadow-[0_20px_50px_rgba(14,165,233,0.15)]">
